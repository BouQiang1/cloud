...
def parse_args():
    ...
    parser.add_argument('--model', default='pointnet_cls_office', help='model name')
    ...
    parser.add_argument('--log_dir', type=str, default='pointnet-office', help='experiment root')
    parser.add_argument('--use_normals', action='store_true', default=False, help='use normals')
    parser.add_argument('--use_uniform_sample', action='store_true', default=True, help='use FPS sampiling')
    # cls
    parser.add_argument('--clsTrain_batch_size', type=int, default=32, help='batch size in training')
    parser.add_argument('--clsTest_batch_size', type=int, default=32, help='batch size in Testing')
    parser.add_argument('--cls_path', default='E:/Datas/modelnet40', help='classification data path')
