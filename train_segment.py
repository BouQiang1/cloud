...
def main(args):
    ...
    trainDataLoader = torch.utils.data.DataLoader(train_dataset, batch_size=args.seg_batch_size, shuffle=True, num_workers=4, drop_last=True, pin_memory=True, worker_init_fn=worker_init_fn)
    testDataLoader = torch.utils.data.DataLoader(test_dataset, batch_size=args.seg_batch_size, shuffle=False, num_workers=4, drop_last=True)
